...
class AuthTestCase(unittest.TestCase):
    ...
    def setup(self):
        ...
        self.app = create_app(config_name="tetsing")
        #initialize the test client
        self.client = self.app.test_client
        # This is the user test json data wilt a predified email and password
        self.user_data = {
    ...
    def test_registaration(self):
        # Test user registration works correctly
        res = self.client().post('/auth/register', data=self.user_data)
        # get the result returned in json format
